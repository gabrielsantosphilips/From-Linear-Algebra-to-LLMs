...
=\mathbf{U}\mathbf{\Sigma}\mathbf{V}^\top$. $\blacksquare$

**Theorem 3.9 (Eckart–Young).** Let $\mathbf{A}_k=\sum_{i=1}^k
\sigma_i\mathbf{u}_i\mathbf{v}_i^\top$. Among all rank-$k$ matrices
$\mathbf{B}$,
$$
